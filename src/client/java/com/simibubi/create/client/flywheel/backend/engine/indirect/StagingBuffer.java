...
import com.simibubi.create.client.flywheel.backend.gl.GlFence;
...
import com.simibubi.create.client.flywheel.lib.memory.FlwMemoryTracker;
...
public class StagingBuffer {
    ...
    private void dispatchComputeCopies() {
        programs.getScatterProgram().bind();
