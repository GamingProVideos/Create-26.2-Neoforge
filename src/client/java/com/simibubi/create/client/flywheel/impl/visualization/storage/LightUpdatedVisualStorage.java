...
import com.simibubi.create.client.flywheel.api.visual.LightUpdatedVisual;
import com.simibubi.create.client.flywheel.lib.task.Distribute;
import com.simibubi.create.client.flywheel.lib.task.SimplyComposedPlan;
import com.simibubi.create.client.flywheel.lib.task.Synchronizer;
...
public class LightUpdatedVisualStorage {
    ...
    private void addInner(LightUpdatedVisual visual, SectionTracker tracker) {
        ...
        for (long section : sections) {
            section2Updaters.computeIfAbsent(section, $ -> new ObjectArrayList<>()).add(updater);
        }
    }
