...
import com.simibubi.create.client.flywheel.backend.InternalVertex;
import com.simibubi.create.client.flywheel.backend.MaterialShaderIndices;
import com.simibubi.create.client.flywheel.backend.Samplers;
import com.simibubi.create.client.flywheel.backend.compile.component.InstanceStructComponent;
import com.simibubi.create.client.flywheel.backend.compile.component.UberShaderComponent;
import com.simibubi.create.client.flywheel.backend.compile.core.CompilationHarness;
import com.simibubi.create.client.flywheel.backend.compile.core.Compile;
import com.simibubi.create.client.flywheel.backend.engine.uniform.FrameUniforms;
import com.simibubi.create.client.flywheel.backend.engine.uniform.Uniforms;
import com.simibubi.create.client.flywheel.backend.gl.GlCompat;
import com.simibubi.create.client.flywheel.backend.gl.shader.GlProgram;
import com.simibubi.create.client.flywheel.backend.gl.shader.ShaderType;
import com.simibubi.create.client.flywheel.backend.glsl.GlslVersion;
import com.simibubi.create.client.flywheel.backend.glsl.ShaderSources;
import com.simibubi.create.client.flywheel.backend.glsl.SourceComponent;
import com.simibubi.create.client.flywheel.backend.glsl.generate.FnSignature;
import com.simibubi.create.client.flywheel.backend.glsl.generate.GlslExpr;
