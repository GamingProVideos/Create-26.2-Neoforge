...
public class TrainScenes {
    ...
    public static void controls(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showText(60).pointAt(util.vector().of(3.35f, 3.75f, 5)).placeNearTarget().attachKeyFrame()
        ...
        scene.overlay().showText(60).pointAt(util.vector().of(7.35f, 3.75f, 5)).placeNearTarget()
        ...
        scene.overlay().showText(90).pointAt(util.vector().of(3.35f, 3.75f, 5)).placeNearTarget()
        ...
        scene.overlay().showText(80).pointAt(util.vector().topOf(stationPos)).placeNearTarget()
        ...
        scene.overlay().showText(70).pointAt(util.vector().of(4.95f, 3.75f, 5)).placeNearTarget().attachKeyFrame()
    ...
    public static void schedule(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showText(110).pointAt(birbVec).placeNearTarget().attachKeyFrame()
        ...
        scene.overlay().showText(70).pointAt(target).placeNearTarget().colored(PonderPalette.BLUE).attachKeyFrame()
