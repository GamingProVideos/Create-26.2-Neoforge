...
public class RequesterAndShopScenes {
    ...
    public static void requester(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        BlockPos pack = util.grid().at(3, 2, 4);
        BlockPos link = util.grid().at(3, 3, 4);
        ...
        BlockPos req = util.grid().at(3, 1, 1);
        ...
        scene.world().createItemOnBelt(util.grid().at(2, 1, 4), Direction.EAST, box);
        scene.idle(15);
        ...
        PonderHilo.packagerClear(scene, pack);
        scene.world().createItemOnBelt(util.grid().at(2, 1, 4), Direction.EAST, box2);
        scene.idle(15);

        scene.world().toggleRedstonePower(util.select().fromTo(1, 1, 1, 3, 1, 1));
        scene.idle(60);

        scene.world().hideSection(reqS, Direction.UP);
        scene.world().hideSection(buttonAndRedstone, Direction.WEST);
        scene.idle(15);
        ElementLink<WorldSectionElement> tickerL = scene.world().showIndependentSection(ticker, Direction.DOWN);
