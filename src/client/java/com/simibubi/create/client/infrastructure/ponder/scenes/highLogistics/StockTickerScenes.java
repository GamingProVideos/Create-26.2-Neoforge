...
import com.simibubi.create.client.ponder.api.element.ParrotPose.FacePointOfInterestPose;
...
public class StockTickerScenes {
    ...
    public static void stockTicker(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        BlockPos link1 = util.grid().at(3, 3, 5);
        BlockPos link2 = util.grid().at(5, 3, 5);
        BlockPos pack1 = util.grid().at(3, 2, 5);
        BlockPos pack2 = util.grid().at(5, 2, 5);
        BlockPos fun1 = util.grid().at(3, 2, 4);
        BlockPos fun2 = util.grid().at(5, 2, 4);
        Selection link1S = util.select().position(link1);
        Selection link2S = util.select().position(link2);
        Selection pack1S = util.select().position(pack1);
        Selection pack2S = util.select().position(pack2);
        Selection fun1S = util.select().position(fun1);
        Selection fun2S = util.select().position(fun2);
        Selection vault = util.select().fromTo(4, 1, 6, 5, 3, 6);
        Selection chest = util.select().fromTo(3, 1, 6, 3, 2, 6);
        Selection scaff2 = util.select().position(5, 1, 5);
        Selection scaff1 = util.select().position(3, 1, 5);
        Selection belt1 = util.select().fromTo(6, 1, 4, 2, 1, 4);
        Selection cog1 = util.select().position(6, 1, 3);
        Selection largeCog1 = util.select().position(7, 0, 3);
        Selection cog2 = util.select().position(2, 1, 6);
        Selection largeCog2 = util.select().position(2, 0, 7);
        Selection belt2 = util.select().fromTo(1, 1, 6, 1, 1, 1);
        Selection trapdoor = util.select().position(1, 1, 0);
        Selection cannon = util.select().position(2, 1, 3);
        BlockPos ticker = util.grid().at(3, 1, 1);
        Selection tickerS = util.select().position(3, 1, 1);
        Selection seat = util.select().position(4, 1, 1);

        scene.idle(10);

        ElementLink<WorldSectionElement> linkL = scene.world().showIndependentSection(link1S, Direction.DOWN);
        ...
        scene.idle(5);
        scene.world().showSection(scaff1, Direction.NORTH);
        scene.world().showSection(scaff2, Direction.NORTH);
        scene.idle(8);
        scene.world().showSection(pack1S, Direction.NORTH);
        scene.idle(2);
        ...
        scene.world().cycleBlockProperty(pack1, PackagerBlock.LINKED);
        scene.world().cycleBlockProperty(pack2, PackagerBlock.LINKED);
        scene.effects().indicateSuccess(pack1);
        scene.effects().indicateSuccess(pack2);
        scene.idle(15);
        ...
        scene.overlay().showOutline(PonderPalette.BLUE, link1, util.select().position(3, 2, 6), 120);
        ...
        scene.idle(10);
        scene.world().showSection(trapdoor, Direction.SOUTH);
        scene.idle(5);
        scene.world().showSection(fun1S, Direction.DOWN);
        scene.idle(5);
        scene.world().showSection(fun2S, Direction.DOWN);
        scene.idle(10);

        scene.world().createItemOnBelt(util.grid().at(3, 1, 4), Direction.SOUTH, box1);
        PonderHilo.packagerClear(scene, pack1);
        scene.idle(5);
        scene.world().createItemOnBelt(util.grid().at(5, 1, 4), Direction.SOUTH, box2);
        ...
        scene.idle(2);
        scene.world().hideSection(belt1, Direction.NORTH);
        scene.world().hideSection(belt2, Direction.WEST);
        scene.world().hideSection(cog2, Direction.WEST);
        scene.world().hideSection(cog1, Direction.NORTH);
        scene.world().hideSection(trapdoor, Direction.WEST);
        scene.world().hideSection(fun1S, Direction.NORTH);
    ...
    public static void stockTickerAddress(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Selection vault = util.select().fromTo(6, 1, 6, 8, 3, 8);
        BlockPos pack = util.grid().at(7, 2, 5);
        BlockPos link = util.grid().at(7, 3, 5);
        Selection belt1 = util.select().fromTo(8, 1, 4, 2, 1, 4).add(util.select().position(4, 2, 4));
        Selection belt2 = util.select().fromTo(4, 1, 0, 3, 1, 3);
        Selection largeCog = util.select().position(2, 0, 9);
        Selection cog = util.select().fromTo(3, 1, 5, 3, 1, 9);
        Selection frog = util.select().position(7, 1, 1);
        Selection postBox = util.select().fromTo(6, 1, 2, 6, 2, 2);
        BlockPos seat = util.grid().at(1, 1, 6);
        Selection tickerS = util.select().fromTo(2, 1, 6, 2, 2, 6);
        BlockPos ticker = util.grid().at(2, 2, 6);
        Selection funnel = util.select().position(7, 2, 4);
        Selection linkAndPackager = util.select().fromTo(7, 1, 5, 7, 3, 5);
        Selection seatS = util.select().position(1, 1, 6);

        scene.idle(10);
        scene.world().showSection(vault, Direction.DOWN);
        scene.world().showSection(linkAndPackager, Direction.SOUTH);
        scene.idle(5);
        scene.world().showSection(tickerS, Direction.DOWN);
        scene.world().showSection(seatS, Direction.EAST);
        scene.idle(10);
        scene.special().createBirb(util.vector().centerOf(seat), FacePointOfInterestPose::new);
        ...
        scene.world().showSection(cog, Direction.WEST);
        ...
        scene.world().createItemOnBelt(util.grid().at(7, 1, 4), Direction.SOUTH, box1);
        ...
        scene.world().createItemOnBelt(util.grid().at(7, 1, 4), Direction.SOUTH, box2);
        PonderHilo.packagerClear(scene, pack);
        scene.idle(15);
        ...
        scene.world().hideSection(cog, Direction.WEST);
        scene.world().hideSection(largeCog, Direction.DOWN);
        scene.world().hideSection(funnel, Direction.UP);
        scene.idle(5);
        scene.world().hideSection(belt2, Direction.NORTH);
        scene.rotateCameraY(15);
        scene.idle(15);

        ElementLink<WorldSectionElement> extrasL = scene.world().showIndependentSection(postBox, Direction.DOWN);
        scene.world().moveSection(extrasL, util.vector().of(-3, 0, 2), 0);
        scene.idle(5);
