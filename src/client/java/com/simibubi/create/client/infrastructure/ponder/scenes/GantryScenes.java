...
public class GantryScenes {
    ...
    public static void direction(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (i == 0) {
                scene.overlay().showText(80).attachKeyFrame().text("...as well as the rotation direction of the shaft")
                    .pointAt(util.vector().blockSurface(lastShaft, Direction.WEST)).placeNearTarget();
            }
