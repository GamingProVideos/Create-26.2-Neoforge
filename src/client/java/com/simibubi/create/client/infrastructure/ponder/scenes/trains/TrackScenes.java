...
public class TrackScenes {
    ...
    public static void placement(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay().showText(60).pointAt(util.vector().topOf(5, 0, 9)).placeNearTarget()
        ...
        scene.overlay().showControls(util.vector().topOf(8, 0, 2), Pointing.DOWN, 15).rightClick().withItem(trackStack);
        scene.idle(15);
        scene.overlay().showControls(util.vector().topOf(2, 0, 8), Pointing.DOWN, 15).rightClick().withItem(trackStack);
        scene.idle(7);
    ...
    public static void portal(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(15);
        scene.overlay().showText(60).pointAt(util.vector().topOf(4, 0, 6)).placeNearTarget().attachKeyFrame()
        ...
        scene.idle(20);
        scene.overlay().showText(70).pointAt(util.vector().topOf(4, 0, 6)).placeNearTarget()
    ...
    public static void chunks(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(15);
        scene.overlay().showText(60).pointAt(util.vector().topOf(1, 0, 4)).placeNearTarget().attachKeyFrame()
