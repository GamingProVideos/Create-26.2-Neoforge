...
import com.simibubi.create.client.foundation.ponder.CreateSceneBuilder.WorldInstructions;
...
import com.simibubi.create.client.ponder.api.scene.SelectionUtil;
...
public class RedstoneScenes2 {
    ...
    public static void pulseTimer(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        world.moveSection(link, util.vector().of(0, 0, -2), 0);
        scene.idle(10);
