...
import com.simibubi.create.catnip.config.ui.ConfigAnnotations;
...
public class CClient extends ConfigBase {
    ...
    public final ConfigBool ignoreFabulousWarning = b(false, "ignoreFabulousWarning", Comments.ignoreFabulousWarning);
    public final ConfigBool rotateWhenSeated = b(true, "rotateWhenSeated", Comments.rotatewhenSeated);
    ...
    public final ConfigInt overlayBorderColorTop = i(
        0x50_5000ff,
        Integer.MIN_VALUE,
        Integer.MAX_VALUE,
    ...
    public final ConfigInt overlayBorderColorBot = i(
        0x50_28007f,
        Integer.MIN_VALUE,
        Integer.MAX_VALUE,
