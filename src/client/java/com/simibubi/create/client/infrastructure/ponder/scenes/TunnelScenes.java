...
import com.simibubi.create.foundation.blockEntity.behaviour.filtering.ServerSidedFilteringBehaviour;
...
public class TunnelScenes {
    ...
    public static void brass(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntity(
            tunnelPos,
            tunnelClass,
            be -> be.getBehaviour(ServerSidedFilteringBehaviour.TYPE).setFilter(Direction.EAST, ItemStack.EMPTY)
        );
        ...
        scene.world().modifyBlockEntity(
            tunnelPos,
            tunnelClass,
            be -> be.getBehaviour(ServerSidedFilteringBehaviour.TYPE).setFilter(Direction.NORTH, ItemStack.EMPTY)
        );
        scene.world().modifyBlockEntity(
            tunnelPos,
            tunnelClass,
            be -> be.getBehaviour(ServerSidedFilteringBehaviour.TYPE).setFilter(Direction.WEST, ItemStack.EMPTY)
        );
        scene.idle(10);
        ...
        scene.world().modifyBlockEntity(
            newTunnelPos.north(),
            tunnelClass,
            be -> be.getBehaviour(ServerSidedFilteringBehaviour.TYPE).setFilter(Direction.WEST, item1)
        );
        scene.idle(4);
        ...
        scene.world().modifyBlockEntity(
            newTunnelPos.south(),
            tunnelClass,
            be -> be.getBehaviour(ServerSidedFilteringBehaviour.TYPE).setFilter(Direction.WEST, item3)
        );
        scene.idle(30);
