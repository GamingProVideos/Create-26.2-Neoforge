...
public class CartAssemblerScenes {
    ...
    public static void anchor(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showControls(util.vector().centerOf(assemblerPos), Pointing.DOWN, 30).rightClick()
            .withItem(AllItems.CART_ASSEMBLER.getDefaultInstance());
        scene.idle(7);
        scene.world().setBlock(
            assemblerPos,
            AllBlocks.CART_ASSEMBLER.defaultBlockState().setValue(CartAssemblerBlock.RAIL_SHAPE, RailShape.NORTH_SOUTH)
                .setValue(CartAssemblerBlock.RAIL_TYPE, CartAssembleRailType.REGULAR),
            true
        );
        scene.idle(20);
        ...
        scene.overlay().showText(80).attachKeyFrame().sharedText("movement_anchors")
            .pointAt(util.vector().blockSurface(util.grid().at(1, 3, 2), Direction.NORTH)).placeNearTarget();
        scene.idle(80);
        scene.world().toggleRedstonePower(toggle);
        scene.effects().indicateRedstone(leverPos);
        ...
        scene.overlay().showControls(cartCenter.add(0, 0, 4), Pointing.DOWN, 20).rightClick().withItem(asStack);
        scene.idle(20);
    ...
    public static void modes(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().setBlock(
            assemblerPos,
            AllBlocks.CART_ASSEMBLER.defaultBlockState().setValue(CartAssemblerBlock.RAIL_SHAPE, RailShape.EAST_WEST)
                .setValue(CartAssemblerBlock.RAIL_TYPE, CartAssembleRailType.REGULAR),
            true
        );
        scene.idle(5);
    ...
    public static void dual(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().setBlock(
            assembler1,
            AllBlocks.CART_ASSEMBLER.defaultBlockState().setValue(CartAssemblerBlock.RAIL_SHAPE, RailShape.EAST_WEST)
                .setValue(CartAssemblerBlock.RAIL_TYPE, CartAssembleRailType.CONTROLLER_RAIL),
            true
        );
        scene.idle(5);
        scene.world().setBlock(
        ...
        ElementLink<WorldSectionElement> anchors = scene.world()
            .showIndependentSectionImmediately(util.select().fromTo(assembler1.south(), assembler2.south()));
    ...
    public static void rails(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().setBlock(
            assembler,
            AllBlocks.CART_ASSEMBLER.defaultBlockState().setValue(CartAssemblerBlock.RAIL_SHAPE, RailShape.EAST_WEST)
                .setValue(CartAssemblerBlock.RAIL_TYPE, CartAssembleRailType.POWERED_RAIL),
            true
        );
