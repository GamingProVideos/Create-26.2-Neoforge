...
public class HosePulleyScenes {
    ...
    public static void intro(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().setKineticSpeed(kinetics, 0);
        scene.idle(5);
        scene.overlay().showText(70).text("...or pull from it, draining the pool instead").attachKeyFrame()
    ...
    public static void level(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().setKineticSpeed(kinetics, 0);
        scene.overlay().showText(40).text("Draining runs from top to bottom").attachKeyFrame().placeNearTarget()
        ...
        scene.overlay().showText(40).text("Filling runs from bottom to top").attachKeyFrame().placeNearTarget()
            .pointAt(util.vector().centerOf(hosePos.below(3)));
        scene.idle(10);
    ...
    public static void infinite(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntity(
            ...
            be -> be.getTankInventory().insert(new FluidStack(Fluids.WATER, 1944000))
        );
