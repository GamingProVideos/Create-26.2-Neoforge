...
import com.simibubi.create.client.catnip.lang.FontHelper;
...
public class PonderTagIndexScreen extends AbstractPonderScreen {
    ...
    protected void setupModTagEntries() {
        ...
        String modName = ModList.get().getModContainerById(entry.getKey())
            .map(mod -> mod.getModInfo().getDisplayName()).orElseGet(entry::getKey);
        //TODO
