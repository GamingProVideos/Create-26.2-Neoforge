package com.simibubi.create.client.ponder.foundation.render;
...
import com.simibubi.create.client.catnip.gui.render.GpuTexture;
import com.simibubi.create.client.catnip.render.PonderRenderTypes;
...
public class SceneRenderer extends PictureInPictureRenderer<SceneRenderState> {
    ...
    private static int windowScaleFactor;
    ...
    public void prepare(
        ...
        if (SceneRenderer.windowScaleFactor != windowScaleFactor) {
            SceneRenderer.windowScaleFactor = windowScaleFactor;
