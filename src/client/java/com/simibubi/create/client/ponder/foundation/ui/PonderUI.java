package com.simibubi.create.client.ponder.foundation.ui;
...
import com.simibubi.create.catnip.animation.LerpedFloat.Chaser;
...
import com.simibubi.create.catnip.registry.RegisteredObjectsHelper;
import com.simibubi.create.catnip.theme.Color;
import com.simibubi.create.client.catnip.animation.AnimationTickHolder;
import com.simibubi.create.client.catnip.gui.NavigatableSimiScreen;
import com.simibubi.create.client.catnip.gui.ScreenOpener;
import com.simibubi.create.client.catnip.gui.UIRenderHelper;
...
import com.simibubi.create.client.catnip.gui.element.GuiGameElement.GuiItemRenderBuilder;
import com.simibubi.create.client.catnip.gui.widget.BoxWidget;
import com.simibubi.create.client.catnip.lang.ClientFontHelper;
import com.simibubi.create.client.foundation.sound.SoundScapes;
import com.simibubi.create.client.ponder.Ponder;
import com.simibubi.create.client.ponder.api.registration.StoryBoardEntry;
import com.simibubi.create.client.ponder.api.registration.StoryBoardEntry.SceneOrderingEntry;
import com.simibubi.create.client.ponder.api.registration.StoryBoardEntry.SceneOrderingType;
import com.simibubi.create.client.ponder.enums.PonderConfig;
import com.simibubi.create.client.ponder.enums.PonderGuiTextures;
import com.simibubi.create.client.ponder.foundation.*;
import com.simibubi.create.client.ponder.foundation.PonderScene.SceneTransform;
import com.simibubi.create.client.ponder.foundation.PonderTag.Highlight;
import com.simibubi.create.client.ponder.foundation.content.DebugScenes;
import com.simibubi.create.client.ponder.foundation.element.TextWindowElement;
...
public class PonderUI extends AbstractPonderScreen {
    ...
    public static PonderUI of(ItemStack item) {
        Identifier id = RegisteredObjectsHelper.getKeyOrThrow(item.getItem());
        List<PonderScene> scenes = PonderIndex.getSceneAccess().compile(id);
        Ponder.LOGGER.info("Opening Ponder for {} with {} scene(s)", id, scenes.size());
        return new PonderUI(scenes);
    }
