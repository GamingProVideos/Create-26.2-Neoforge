...
import com.simibubi.create.client.content.equipment.blueprint.BlueprintScreen;
import com.simibubi.create.client.content.equipment.toolbox.ToolboxScreen;
import com.simibubi.create.client.content.logistics.factoryBoard.FactoryPanelSetItemScreen;
import com.simibubi.create.client.content.logistics.filter.AttributeFilterScreen;
import com.simibubi.create.client.content.logistics.filter.FilterScreen;
import com.simibubi.create.client.content.logistics.filter.PackageFilterScreen;
import com.simibubi.create.client.content.logistics.packagePort.PackagePortScreen;
import com.simibubi.create.client.content.logistics.redstoneRequester.RedstoneRequesterScreen;
import com.simibubi.create.client.content.logistics.stockTicker.StockKeeperCategoryScreen;
import com.simibubi.create.client.content.logistics.stockTicker.StockKeeperRequestScreen;
import com.simibubi.create.client.content.redstone.link.controller.LinkedControllerScreen;
import com.simibubi.create.client.content.schematics.cannon.SchematicannonScreen;
import com.simibubi.create.client.content.schematics.table.SchematicTableScreen;
import com.simibubi.create.client.content.trains.schedule.ScheduleScreen;
import com.simibubi.create.client.foundation.gui.menu.ScreenFactory;
