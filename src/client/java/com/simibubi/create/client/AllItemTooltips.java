...
import com.simibubi.create.client.foundation.item.ItemDescription;
import com.simibubi.create.client.foundation.item.KineticStats;
import com.simibubi.create.client.foundation.item.TooltipModifier;
