...
import com.simibubi.create.client.compat.rei.renderer.TwoIconRenderer;
...
public class FanSmokingCategory extends CreateCategory<FanSmokingDisplay> {
    @Override
    public CategoryIdentifier<? extends FanSmokingDisplay> getCategoryIdentifier() {
