package com.simibubi.create.client.foundation.gui.render;
...
public class DrainRenderer extends GuiBlockRenderer<DrainRenderState> {
    ...
    public void prepare(
        ...
        if (DrainRenderer.windowScaleFactor != windowScaleFactor) {
            DrainRenderer.windowScaleFactor = windowScaleFactor;
