...
public class RectangleWithoutSingleCTType extends CTType {
    ...
    public RectangleWithoutSingleCTType() {
        super(Identifier.fromNamespaceAndPath(MOD_ID, "rectangle_without_single"), SIZE, AXIS_ALIGNED);
    }
