...
package com.simibubi.create.client.model.obj;
...
import com.simibubi.create.client.model.ExtendedUnbakedGeometry;
import com.simibubi.create.client.model.NeoForgeModelProperties;
import com.simibubi.create.client.model.StandardModelParameters;
import net.neoforged.neoforge.client.model.UnbakedElementsHelper;
import com.simibubi.create.client.model.obj.ObjMaterialLibrary.Material;
...
public class ObjGeometry implements ExtendedUnbakedGeometry {
    ...
    private Pair<BakedQuad, Direction> makeQuad(
        ...
        // Minecraft 26.2 also requires the matching inverse face transform to be applied to UVs.
        ...
        for (int i = 0; i < 4; i++) {
            ...
            quadBaker.setUv(texture.getU(u), texture.getV(v));
    ...
    private class ModelMesh {
        ...
        public void addQuads(
            ...
            // Compose the root transform into the full ModelState rather than passing only
            // its matrix. This preserves UV lock/face transformation information on 26.2.
