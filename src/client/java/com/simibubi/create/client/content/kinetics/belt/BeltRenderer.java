package com.simibubi.create.client.content.kinetics.belt;
...
import com.simibubi.create.client.content.kinetics.belt.BeltRenderer.BeltRenderState;
...
import static com.simibubi.create.client.content.kinetics.base.KineticBlockEntityRenderer.*;
...
public class BeltRenderer implements BlockEntityRenderer<BeltBlockEntity, BeltRenderState> {
    ...
    public boolean shouldRender(BeltBlockEntity blockEntity, Vec3 cameraPosition) {
        // Belts are rendered by this BER on 26.2 even when Flywheel is available.
        // Every belt segment needs its own top/bottom/pulley geometry; restricting this
        // to the controller is what makes the remaining segments disappear.
    ...
    public void extractRenderState(
        ...
        // This port deliberately uses the vanilla/BER belt path. The normal blockstate
        // for an uncased belt is only a particle model, so skipping the BER geometry
        // when Flywheel is globally supported makes the entire belt invisible.
