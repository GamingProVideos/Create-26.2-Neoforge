...
import com.simibubi.create.infrastructure.packet.c2s.ServerboundChainConveyorRidingPacket;
...
public class ChainConveyorRidingHandler {
    ...
    public static void embark(Minecraft mc, BlockPos lift, float position, BlockPos connection) {
