package com.simibubi.create.client.content.kinetics.saw;
...
import com.simibubi.create.client.content.kinetics.saw.SawRenderer.SawRenderState;
...
import com.simibubi.create.client.flywheel.lib.transform.PoseTransformStack;
    ...
    public void extractRenderState(
        ...
        if (axis == Axis.Y) {
            ...
            state.shaft = CachedBuffers.partialFacing(
                ...
                state.blockState.rotate(Rotation.CLOCKWISE_180)
