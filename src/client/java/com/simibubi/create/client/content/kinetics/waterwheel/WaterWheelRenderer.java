package com.simibubi.create.client.content.kinetics.waterwheel;
...
import com.simibubi.create.client.catnip.render.*;
import com.simibubi.create.client.catnip.render.SuperByteBufferCache.Compartment;
...
import com.simibubi.create.client.foundation.model.BakedModelHelper;
...
import static com.simibubi.create.client.content.kinetics.base.KineticBlockEntityRenderer.getRotateAngleWithoutBeOffset;
...
public class WaterWheelRenderer implements BlockEntityRenderer<WaterWheelBlockEntity, SingleKineticRenderState> {
    ...
    public void extractRenderState(
        ...
        // The 1.21.x renderer applied packed block light only. Applying CardinalLighting
        // before the wheel's runtime rotation makes faces become extremely dark/black on
        // 26.2 because the directional lighting no longer follows the rotated OBJ normals.
        state.model = getRotatedModel(be.material, state.blockState).light(state.lightCoords)
