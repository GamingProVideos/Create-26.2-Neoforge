...
public class CTrains extends ConfigBase {
    ...
    public final ConfigInt maxTrackPlacementLength = i(
        32,
        16,
        128,
        "maxTrackPlacementLength",
        Comments.maxTrackPlacementLength
    );
    ...
    public final ConfigFloat manualTrainSpeedModifier = f(
        0.75f,
        0,
        "manualTrainSpeedModifier",
        Comments.manualTrainSpeedModifier
    );
    ...
    public final ConfigFloat trainTurningTopSpeed = f(
        14,
        0,
        "trainTurningTopSpeed",
        Comments.mps,
        Comments.trainTurningTopSpeed
    );
    ...
    public final ConfigFloat poweredTrainTopSpeed = f(
        40,
        0,
        "poweredTrainTopSpeed",
        Comments.mps,
        Comments.poweredTrainTopSpeed
    );
    public final ConfigFloat poweredTrainTurningTopSpeed = f(
        20,
        0,
        "poweredTrainTurningTopSpeed",
        Comments.mps,
        Comments.poweredTrainTurningTopSpeed
    );
    public final ConfigFloat poweredTrainAcceleration = f(
        3,
        0,
        "poweredTrainAcceleration",
        Comments.acc,
        Comments.poweredTrainAcceleration
    );
