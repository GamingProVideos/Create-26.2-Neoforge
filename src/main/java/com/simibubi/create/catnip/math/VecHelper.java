package com.simibubi.create.catnip.math;
...
public class VecHelper {
    ...
    public static boolean isVecPointingTowards(Vec3 vec, Direction direction) {
        return Vec3.atLowerCornerOf(direction.getUnitVec3i())
    ...
    public static double @Nullable [] intersect(Vec3 p1, Vec3 p2, Vec3 r, Vec3 s, Axis plane) {
        if (plane == Axis.X) {
