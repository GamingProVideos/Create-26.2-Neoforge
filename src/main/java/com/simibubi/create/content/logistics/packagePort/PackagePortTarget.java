...
public abstract class PackagePortTarget {
    ...
    // Stable names also make source-ported addon target types safe across connections.
    private static final StreamCodec<RegistryFriendlyByteBuf, PackagePortTargetType> TYPE_PACKET_CODEC =
        CreateStreamCodecs.registryByName(CreateRegistries.PACKAGE_PORT_TARGET_TYPE);
    ...
    public static class ChainConveyorFrogportTarget extends PackagePortTarget {
        ...
        public ChainConveyorFrogportTarget(
            BlockPos relativePos,
            float chainPos,
            Optional<BlockPos> connection,
            boolean flipped
        ) {
        ...
        public ItemStack getIcon() {
            return AllItems.CHAIN_CONVEYOR.getDefaultInstance();
        }
        ...
        public void register(PackagePortBlockEntity ppbe, LevelAccessor level, BlockPos portPos) {
            ...
            if (connection != null && clbe.getSpeed() < 0 != flipped) {
                ...
                actualBe = AllBlocks.CHAIN_CONVEYOR.getBlockEntity(level, clbe.getBlockPos().offset(connection));
                if (actualBe == null) {
                    return;
                }
                clbe.prepareStats();
                ...
                flipped = !flipped;
                relativePos = actualBe.getBlockPos().subtract(portPos);
                ppbe.notifyUpdate();
            }
        ...
        public static class Type implements PackagePortTargetType {
            ...
            @Override
            public StreamCodec<ByteBuf, ChainConveyorFrogportTarget> packetCodec() {
                return PACKET_CODEC;
            }
        }
    }
    ...
    public static class TrainStationFrogportTarget extends PackagePortTarget {
        ...
        public static final StreamCodec<ByteBuf, TrainStationFrogportTarget> PACKET_CODEC = BlockPos.STREAM_CODEC.map(TrainStationFrogportTarget::new,
            i -> i.relativePos
        );
        ...
        public static class Type implements PackagePortTargetType {
            ...
            @Override
            public StreamCodec<ByteBuf, TrainStationFrogportTarget> packetCodec() {
                return PACKET_CODEC;
            }
        }
    }
